...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Dd1fKYfB.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-B3LO_acg.css";
...
var $$splitComponentImporter$3 = () => import("./routes-9FAL-Oks.mjs");
var Route$3 = createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "Zervine Kitchen — Signature Mentai Rice (Pre-Order)" },
		{
			name: "description",
			content: "Zervine Kitchen — handcrafted mentai since 2020. Salmon, beef & dimsum mentai plus the new Mentai Shirataki, made fresh every pre-order batch. Order easily via WhatsApp."
		},
		{
			property: "og:title",
			content: "Zervine Kitchen — Signature Mentai (Pre-Order)"
		},
		{
			property: "og:description",
			content: "Handcrafted mentai made fresh on every pre-order batch. Salmon, beef, dimsum & new shirataki mentai. Order via WhatsApp."
		},
		{
			property: "og:type",
			content: "website"
...
var $$splitComponentImporter$1 = () => import("./auth-DIoBKLK_.mjs");
var Route$1 = createFileRoute("/auth")({
	head: () => ({ meta: [
		{ title: "Admin Login — Zervine Kitchen" },
		{
			name: "description",
			content: "Halaman masuk admin Zervine Kitchen untuk melihat rekap pesanan pre-order mentai."
		},
		{
			property: "og:title",
			content: "Admin Login — Zervine Kitchen"
		},
		{
			property: "og:description",
...
var $$splitComponentImporter = () => import("./admin-1XGZ6zNf.mjs");
var Route = createFileRoute("/_authenticated/admin")({
	head: () => ({ meta: [
		{ title: "Rekap Pesanan — Zervine Kitchen" },
		{
			name: "description",
			content: "Rekap semua pesanan pre-order Zervine Kitchen: nama pembeli, alamat, menu, jumlah, dan status pesanan."
		},
		{
			property: "og:title",
			content: "Rekap Pesanan — Zervine Kitchen"
		},
		{
			property: "og:description",
